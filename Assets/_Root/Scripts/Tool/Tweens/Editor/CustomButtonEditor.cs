...
namespace Tween.Editor
{
    ...
    internal class CustomButtonEditor : ButtonEditor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var changedColor = new PropertyField(serializedObject.FindProperty(CustomButton_Obsolete.ChangedColor));
            var buttonImage = new PropertyField(serializedObject.FindProperty(CustomButton_Obsolete.ButtonImage));
